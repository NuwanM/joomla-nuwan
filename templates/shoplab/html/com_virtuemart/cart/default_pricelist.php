...
<tr>
	...
	<th align="left" style="width:5%;"><?php echo vmText::_ ('COM_VIRTUEMART_CART_SKU') ?></th>
	<th style="min-width:70px; width:10%; align:right; text-align:center"><?php echo vmText::_ ('COM_VIRTUEMART_CART_PRICE') ?></th>
	<th style="min-width:120px;align:right;text-align:center"><?php echo vmText::_ ('COM_VIRTUEMART_CART_QUANTITY') ?>
	...
	<?php if (VmConfig::get ('show_tax')) {
		...
		?>
	<th style="min-width:76px;align:right;text-align:center;width: 10%;"><?php echo "<span  class='priceColor2'>" . $tax . '</span>' ?></th>
	<?php } ?>
	<th style="min-width:76px;align:right;text-align:center;width: 10%;"><?php echo "<span  class='priceColor2'>" . vmText::_ ('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') . '</span>' ?></th>
	<th style="min-width:80px;align:right;text-align:center;width: 15%;"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOTAL') ?></th>
</tr>
